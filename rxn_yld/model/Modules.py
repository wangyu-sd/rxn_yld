...
class RxnYdEncoder(nn.Module):
    __constants__ = ['norm']

    def __init__(self, encoder_layer, num_layers, norm=None):
        super(RxnYdEncoder, self).__init__()
...
class RxnYdEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, activation=F.gelu,
        ...
        super(RxnYdEncoderLayer, self).__init__()
    ...
    def __setstate__(self, state):
        ...
        super(RxnYdEncoderLayer, self).__setstate__(state)
...
class RxnYdDecoder(nn.Module):
    __constants__ = ['norm']

    def __init__(self, decoder_layer, num_layers, norm=None):
        super(RxnYdDecoder, self).__init__()
...
class RxnYdDecoderLayer(nn.Module):
    __constants__ = ['batch_first', 'norm_first']

    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, activation=F.gelu,
                 layer_norm_eps=1e-5, batch_first=False, norm_first=False) -> None:
        super(RxnYdDecoderLayer, self).__init__()
    ...
    def __setstate__(self, state):
        if 'activation' not in state:
            state['activation'] = F.gelu
        super(RxnYdDecoderLayer, self).__setstate__(state)
